  ...
  return (
    <div className='h-full md:h-screen w-full bg-[#393333]'>
      ...
      <div className='flex flex-col md:flex-row mt-5'>
        <a href='https://task-board-sand.vercel.app/' target='_blank'> <Card title="Task-Board" desc="A React app for practicing package integration with a visually appealing to-do list. It offers interactive features for users to manage tasks and experiment with various functionalities." src={myPrj1} /></a>
